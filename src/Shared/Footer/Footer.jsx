    ...
    return (
        <div className='font-inter text-white'>
            <div className='flex '>
                ...
                <div className='w-1/2 bg-[#111827] text-center flex flex-col justify-center items-center'>
                    <nav className='font-medium'>
                        ...
                        <div className="flex gap-6 text-center justify-center mt-5">
                            <a>
                                <svg
            ...
            <footer className="footer footer-center bg-[#151515] text-white p-4">
                <aside>
                    <p className=' font-medium'>Copyright © {new Date().getFullYear()} - All right reserved by BISTRO BOSS Restaurant Ltd</p>
                </aside>
            </footer>
        </div>
    );
